...
<svelte:head>
	<title>Terms of Service - KnowledgeRepo</title>
	<meta name="description" content="Terms of Service for KnowledgeRepo" />
</svelte:head>
...
<div class="container mx-auto px-4 py-8" in:fade>
	<div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
		...
		<div class="space-y-6 text-gray-700">
			...
			<section>
				<h2 class="text-xl font-semibold text-gray-800 mb-3">3. Content Guidelines</h2>
			...
			<section>
				...
				<div class="bg-gray-50 p-4 rounded-lg mt-2">
					<p>Email: legal@knowledgerepo.com</p>
					<p>Address: 123 Knowledge Street, Tech City, TC 12345</p>
				</div>
			</section>

			<p class="text-sm text-gray-600">Last Updated: January 1, 2024</p>
		</div>
	</div>
</div>