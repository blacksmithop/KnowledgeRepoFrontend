...
<div class="fixed bottom-[var(--footer-height)] right-4">
	{#if isOpen}
		<div
			transition:slide
			class="bg-white rounded-t-lg shadow-lg border w-96 mb-4"
		>
			<div class="p-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-t-lg flex justify-between items-center">
			...
			<div class="h-96 overflow-y-auto p-4 bg-gray-50">
				...
				{#each chatHistory as message}
					<div class="mb-4 flex items-start gap-2 {message.type === 'user' ? 'flex-row-reverse' : ''}">
